...
class EmployeeRecordsMenu implements Menu {
    ...
    class EmployeeSelfServiceMenu implements Menu {
    	 private EmployeeSelfServiceLayer employeeSelfServiceLayer;

    	    public EmployeeSelfServiceMenu(EmployeeSelfServiceLayer employeeSelfServiceLayer) {
    	        this.employeeSelfServiceLayer = employeeSelfServiceLayer;
    	    }
        @Override
        public void display() {
